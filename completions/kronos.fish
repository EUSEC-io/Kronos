...
set -l commands userenum dominfo ingest connect asrep-roast kerbroast spray forcechange gmsa ticket convert request lookupsid install help
...
# Shared flags
complete -c kronos -n "__fish_seen_subcommand_from dominfo connect asrep-roast kerbroast forcechange gmsa lookupsid ingest request" -s u -l username -d "Username"
...
complete -c kronos -n "__fish_seen_subcommand_from connect kerbroast forcechange gmsa lookupsid request" -s H -l hash -d "NTLM Hash"
complete -c kronos -n "__fish_seen_subcommand_from dominfo connect asrep-roast kerbroast forcechange gmsa lookupsid ingest" -s k -l kerberos -d "Use Kerberos authentication"
complete -c kronos -n "__fish_seen_subcommand_from userenum dominfo ingest connect asrep-roast kerbroast spray forcechange gmsa ticket convert request lookupsid" -s h -l help -d "Show help"
